"""
Django settings for muddy_meadow_2 project.
...
ROOT_URLCONF = 'muddy_meadow_2.urls'
...
WSGI_APPLICATION = 'muddy_meadow_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_meadow_2 API",
    "DESCRIPTION": "API documentation for muddy_meadow_2 App",
    "VERSION": "v1",
}
